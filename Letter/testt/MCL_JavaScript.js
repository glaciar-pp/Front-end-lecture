...
function anyPang(){
    ...
    document.getElementById('a1').src = `apGame/${apl[1]}.png`;
    document.getElementById('a2').src = `apGame/${apl[2]}.png`;
    document.getElementById('a3').src = `apGame/${apl[3]}.png`;
    document.getElementById('a4').src = `apGame/${apl[4]}.png`;
    document.getElementById('a5').src = `apGame/${apl[5]}.png`;
    document.getElementById('a6').src = `apGame/${apl[6]}.png`;
    
    const apGame = `${anyPang}`;
    const apTag = document.getElementById('apGame')
    apTag.innerHTML = apGame;
}